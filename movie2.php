...
<body id="main_body" background="up.jpg" >
...
<?php
		...
		$sql = "SELECT * FROM animated_movie where movie_name='Frozen'";
		$res = mysql_query($sql);
	...
	<div><h2>Director:<a href="director2.php">Chris Buck</h2></a></div>
<div><h2>Studio:<a href="studio2.php">Walt Disney Animation</h2></a></div>
...
<h2>watch <a href="click_link2.php">trailer</h2></a>
<h2>to <a href="click_link2.php">download </h2></a>
